...
import { Mail, CheckCircle, Send, MapPin, Shield } from 'lucide-react';
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          <div style={{
            ...
            <h4 style={{ color: 'white', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <Shield size={16} style={{ color: 'hsl(var(--accent-secondary))' }} /> Platform Bilgileri
            </h4>
            <p style={{ margin: 0, lineHeight: 1.5 }}>
              Instascope, Emre Kayahan tarafından bireysel olarak yürütülen bağımsız bir Instagram analiz platformudur. Kullanıcı verilerinin güvenliği önceliğimizdir ve tüm analiz işlemleri client-side (tarayıcınızda) gerçekleştirilir.
            </p>
          </div>
        </div>
